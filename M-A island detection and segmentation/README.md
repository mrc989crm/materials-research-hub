...
trained-models.md provides further information how to get trained segmentation models. Models can be used for predictions on new images of bainitic microstructures (the selected models should match the size of the image, e.g. models in "512x_i_model", "512x_ii_model", "512x_iii_model" are suitable for 512x512 images). 
